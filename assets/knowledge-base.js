...
(function () {
  ...
  var KB = {
    ...
    knowledgePoints: [
      ...
      { id: "math-3-114", name: "线段、射线、直线", subject: "math", grade: 3, term: "上册", unit: "第5单元·线和角", module: "geometry", difficulty: "基础", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "线段有端点、射线一端无限、直线两端无限", keywords: ["线段","射线","直线"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-115", name: "认识角：直角、锐角、钝角", subject: "math", grade: 3, term: "上册", unit: "第5单元·线和角", module: "geometry", difficulty: "基础", source: "syllabus", prerequisiteIds: ["math-3-114"], status: "待制作", file: "", summary: "角的概念、直角锐角钝角的辨认", keywords: ["角","直角","锐角","钝角"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
