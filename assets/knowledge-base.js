...
(function () {
  ...
  var KB = {
    ...
    knowledgePoints: [
      ...
      { id: "math-3-104", name: "同级运算的运算顺序", subject: "math", grade: 3, term: "上册", unit: "第2单元·混合运算", module: "number", difficulty: "基础", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "只含加减或只含乘除，从左到右算", keywords: ["运算顺序","混合运算","同级"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-105", name: "两级运算：先乘除后加减", subject: "math", grade: 3, term: "上册", unit: "第2单元·混合运算", module: "number", difficulty: "基础", source: "syllabus", prerequisiteIds: ["math-3-104"], status: "待制作", file: "", summary: "有乘除有加减时先算乘除再算加减", keywords: ["运算顺序","先乘除后加减"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-106", name: "带小括号的混合运算", subject: "math", grade: 3, term: "上册", unit: "第2单元·混合运算", module: "number", difficulty: "提高", source: "syllabus", prerequisiteIds: ["math-3-105"], status: "待制作", file: "", summary: "先算小括号里的，再算外面的", keywords: ["括号","混合运算","综合算式"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
