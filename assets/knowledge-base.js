...
(function () {
  ...
  var KB = {
    ...
    knowledgePoints: [
      ...
      { id: "math-3-107", name: "毫米与分米的认识", subject: "math", grade: 3, term: "上册", unit: "第3单元·毫米、分米和千米", module: "measure", difficulty: "基础", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "1厘米=10毫米，1分米=10厘米", keywords: ["毫米","分米","长度单位","进率"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-108", name: "千米的认识与换算", subject: "math", grade: 3, term: "上册", unit: "第3单元·毫米、分米和千米", module: "measure", difficulty: "基础", source: "syllabus", prerequisiteIds: ["math-3-107"], status: "待制作", file: "", summary: "1千米=1000米，感受千米有多长", keywords: ["千米","公里","长度单位"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-109", name: "吨的认识（曹冲称象）", subject: "math", grade: 3, term: "上册", unit: "第3单元·毫米、分米和千米", module: "measure", difficulty: "基础", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "1吨=1000千克，感受吨有多重", keywords: ["吨","千克","质量单位","曹冲称象"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
