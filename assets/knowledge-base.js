...
(function () {
  ...
  var KB = {
    ...
    knowledgePoints: [
      ...
      { id: "math-3-110", name: "口算乘法（整十整百）", subject: "math", grade: 3, term: "上册", unit: "第4单元·多位数乘一位数", module: "number", difficulty: "基础", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "整十整百数乘一位数，划0算再添0", keywords: ["口算","乘法","整十整百"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-111", name: "笔算乘法（不进位与进位）", subject: "math", grade: 3, term: "上册", unit: "第4单元·多位数乘一位数", module: "number", difficulty: "基础", source: "syllabus", prerequisiteIds: ["math-3-110"], status: "待制作", file: "", summary: "从个位乘起，满几十向前一位进几", keywords: ["笔算","乘法","进位"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-112", name: "连续进位与 0 的乘法", subject: "math", grade: 3, term: "上册", unit: "第4单元·多位数乘一位数", module: "number", difficulty: "提高", source: "syllabus", prerequisiteIds: ["math-3-111"], status: "待制作", file: "", summary: "连续进位、0乘任何数得0、中间末尾有0", keywords: ["乘法","进位","0的乘法"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-113", name: "用估算解决问题", subject: "math", grade: 3, term: "上册", unit: "第4单元·多位数乘一位数", module: "number", difficulty: "提高", source: "syllabus", prerequisiteIds: ["math-3-110"], status: "待制作", file: "", summary: "把数看作整十整百再估算", keywords: ["估算","近似数","大约"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
