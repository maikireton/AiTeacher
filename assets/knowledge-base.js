...
(function () {
  ...
  var KB = {
    ...
    knowledgePoints: [
      ...
      { id: "math-3-116", name: "认识几分之一", subject: "math", grade: 3, term: "上册", unit: "第6单元·分数的初步认识", module: "number", difficulty: "基础", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "平均分成几份，每份是几分之一", keywords: ["分数","几分之一","平均分"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-117", name: "几分之几与分数大小比较", subject: "math", grade: 3, term: "上册", unit: "第6单元·分数的初步认识", module: "number", difficulty: "基础", source: "syllabus", prerequisiteIds: ["math-3-116"], status: "待制作", file: "", summary: "几分之几表示取几份，同分母/同分子比较", keywords: ["分数","比较大小","几分之几"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-118", name: "同分母分数的加减法", subject: "math", grade: 3, term: "上册", unit: "第6单元·分数的初步认识", module: "number", difficulty: "提高", source: "syllabus", prerequisiteIds: ["math-3-117"], status: "待制作", file: "", summary: "分母不变分子相加减，1减几分之几", keywords: ["分数","加减法","同分母"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
      { id: "math-3-119", name: "搭配问题（数学广角）", subject: "math", grade: 3, term: "上册", unit: "数学广角·搭配", module: "appl", difficulty: "提高", source: "syllabus", prerequisiteIds: [], status: "待制作", file: "", summary: "有序搭配，用连线或树状图不重不漏", keywords: ["搭配","排列组合","树状图"], createdAt: "2026-08-30", updatedAt: "2026-08-30" },
